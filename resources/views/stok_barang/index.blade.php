        ...
        <div class="card">
          ...
          <div class="row">
            ...
            <div class="col-4 text-right">
              <a href="{{ route('stokbarang.add') }}" class="mr-4"><button type="button" class="btn btn-success btn-sm">Tambah Stok Barang</button></a>
            </div>
          </div>
                ...
                <tr>
                  ...
                  <td> <ul class="list-inline m-0">
                            <li class="list-inline-item">
                                <a href="{{ route('stokbarang.edit', Crypt::encrypt($sb->id)) }}"><button class="btn btn-success btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></button></a>
                            </li>
                            <li class="list-inline-item">
                              {{ Form::open(['route' => ['stokbarang.delete', Crypt::encrypt($sb->id)]]) }}
                                    {{ csrf_field() }}
